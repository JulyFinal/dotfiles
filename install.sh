...
# git clone https://ghproxy.com/https://github.com/fast-syntax-highlighting $HOME/.zsh/fsh
# git clone https://ghproxy.com/https://github.com/zsh-completions $HOME/.zsh/zsh-completions
